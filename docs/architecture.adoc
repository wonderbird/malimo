...
:gitplant: http://www.plantuml.com/plantuml/proxy?src=https://raw.githubusercontent.com/wonderbird/malimo/blob/64cf7ec116a259f3187de55f1f9307442947739c/docs/plantuml
